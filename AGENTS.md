...
The task-list management pass is implemented: custom lists can be created, renamed, archived/restored, and deleted only when unused. Inbox cannot be archived or deleted.
