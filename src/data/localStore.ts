...
const STORAGE_KEY = '@yuzuha/app-data/v7';
const LEGACY_SCHEMA_KEYS = ['@yuzuha/app-data/v6', '@yuzuha/app-data/v5', '@yuzuha/app-data/v4', '@yuzuha/app-data/v3', '@yuzuha/app-data/v2', '@yuzuha/app-data/v1'];
