...
- Android supports one optional local reminder per open task, local daily quiet hours, and `Open`/`Complete`/`Snooze 1h` notification actions; user-selected snooze durations, broader notification automation, and sync remain planned.
