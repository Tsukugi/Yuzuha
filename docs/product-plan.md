...
- Android supports one optional local reminder per open task, local daily quiet hours, and `Open`/`Complete` notification actions; snooze, broader notification automation, and sync remain planned.
