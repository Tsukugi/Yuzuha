...
This is the product and engineering baseline for Yuzuha. The code is still a starter scaffold, so documents use clear labels for current behavior and planned behavior. The specification covers the full personal product, not only the first MVP.
