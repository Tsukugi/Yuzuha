...
This is the product and engineering baseline for Yuzuha. Core code exists through local note attachment storage, while later documents use clear labels for current behavior and planned behavior. The specification covers the full personal product, not only the first MVP.
