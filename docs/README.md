...
The latest current-schema pass adds a persisted Sunday/Monday week-start preference after the local-payee pass. It uses app schema 30 and repository schema 3; old versions remain intentionally rejected.
